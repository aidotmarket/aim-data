...
class ArtifactsService:
    ...
    def create_artifact_from_query(
        ...
        """Query file exports were an offline fallback and are no longer supported."""
        if not user_id:
            raise ValueError("user_id is required (NEVER null)")
        raise PermissionError("Query file exports are not available in connected AIM Data")
